...
The illustrated [web interface user guide](docs/user-guide/README.md) is the authoritative description of the interface. The scanner screenshots were refreshed from the experimental `v0.1.3` UI on 2026-08-29; labels, counters and example values can change. The [packet and frame analysis flow](docs/architecture/packet-analysis-flow.md) explains the complete L2/L3 ingress, central IDS and per-protocol dispatch path.
